...
const Sidebar: React.FC = () => {
  ...
  return (
    <div className="w-screen md:min-w-fit md:w-60 md:h-auto fixed bottom-0 md:top-0 z-50 py-5 md:pt-16 md:pb-10 px-8 bg-primarylessDark text-textLighter shadow-xl">
      ...
      <ul className="flex flex-row md:flex-col items-center md:items-start justify-evenly gap-4">
        ...
        <div className="hidden md:inline-block w-full h-0.5 bg-primarylessDarker my-3"></div>
        <li
