    ...
    <div className="flex flex-col lg:flex-row gap-12">
      <Card title="Account Info" className="w-full">
        <form onSubmit={submitHandler} className="grid xl:grid-cols-2 gap-6">
          ...
          <div className="w-full">
            <Input
              id="current-password1"
              type="password"
              placeholder="Current Password"
              value={currentPassword1}
              onChange={(newValue) => setCurrentPassword1(newValue)}
              icon={VscKey}
            />
          </div>
        ...
        >
          <div className="w-full">
            <Input
              ...
              onChange={(newValue) => setCurrentPassword2(newValue)}
              icon={VscKey}
            />
          </div>
          <div className="w-full">
            <Input
              ...
              value={newPassword1}
              onChange={(newValue) => setNewPassword1(newValue)}
              icon={VscKey}
            />
          </div>
          <div className="w-full">
            <Input
              ...
              value={newPassword2}
              onChange={(newValue) => setNewPassword2(newValue)}
              icon={VscKey}
            />
          </div>
          <Button text="Save Changes" className="mx-auto xl:mx-0" />
